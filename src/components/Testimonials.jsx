...
const testimonials = [
    {
        ...
        image: "public/man-smiling.jpg",
        content: "This product has significantly improved my workflow and productivity. Highly recommended!"
    },
    {
        name: "Sara Wilson",
        role: "Product Manager",
        image: "public/women-suit.jpg",
        content: "An essential tool for our team. The user experience is fantastic and the support is top-notch."
    },{
        name: "Mike Davis",
        role: "UX Designer",
        image: "public/man-crossing-arms.jpg",
        content: "I love how intuitive and easy to use this product is. It has made my design process so much smoother."
    }
]
                ...
                <div className="flex flex-col lg:flex-row items-start gap-8 sm:gap-12 lg:gap-16">
                    ...
                    <div className="lg:w-1/2 w-full text-center lg:text-left">
                        <h2 className="text-5xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-4 sm:mb-6">
                            What are developers are saying about us?
                        </h2>
