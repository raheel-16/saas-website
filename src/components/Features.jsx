...
const features = [
    {
        ...
        description: "Boost your productivity with intelligent code suggestions that adapt to your coding style.",
    ...
    },
    {
        ...
        description: "Ensure your code is always working as intended with automated testing tools that catch bugs before they reach production.",
    ...
    },
    {
        ...
        description: "Identify and fix issues faster with AI-assisted debugging that pinpoints problems and suggests solutions.",
        ...
        <div className="max-w-6xl mx-auto">
            ...
            <div className="space-y-16 sm:space-y-20 lg:space-y-32">
                {features.map((feature, key) => (
                    <div key={key} className={`flex flex-col lg:flex-row items-center gap-8 sm:gap-12 ${feature.imagePosition == "right" ? "lg:flex-row-reverse" : "lg:flex-row"}`}>
                        {/* Code Section */}
                            ...
                            <div className="relative group">
                                ...
                                <div className="relative bg-gray-900/50 backdrop-blur-sm border border-gray-700/50 rounded-xl sm:rounded-2xl p-4 sm:p-6 overflow-hidden group-hover:border-1 group-hover:border-blue-600/50 transition-all duration-300">
                                    ...
                                    <div className="bg-gray-950 rounded-lg p-3 sm:p-4 font-mono text-xs sm:text-sm">
                                        ...
                                        <div>
                                            <SyntaxHighlighter language="javascript" style={nightOwl} customStyle={{margin: 0, background: "transparent", borderRadius: "8px", fontSize: "0.75rem", lineHeight: "1.4", height: "100%"}}
                                            wrapLines={true}
                                            >
                                            {feature.codeSnippet}
                                            </SyntaxHighlighter>
                        ...
                        <div className="flex-1 w-full">
                            <div className="max-w-lg mx-auto text-center lg:text-left">
                                <h3 className="text-4xl sm:text-3xl lg:text-4xl font-bold font-bold mb-4 sm:mb-6 text-white">{feature.title}</h3>
